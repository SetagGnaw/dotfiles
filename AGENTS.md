...
- `genai/` groups AI CLI helpers and local model servers, one file per tool: `codex.zsh`, `cursor.zsh`, `claude.zsh`, `skills.zsh` (Claude Code skill management), `agent-browser.zsh`, `litellm.zsh`, and `ollama.zsh`.
